#!/usr/bin/env python3
"""
Upstream schema pipeline: generates entity-schema.json from PeeringDB sources.

Combines three upstream inputs:
...
Outputs workers/api/entity-schema.json, consumed by entities.js.
...
def main():
    """
    Fetch all upstream sources, parse and merge them, emit entity-schema.json.
    ...
    output_path = script_dir.parent / "workers" / "api" / "entity-schema.json"
    ...
    # Quick summary of what the spec added vs the models
