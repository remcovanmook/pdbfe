...
def main():
    ...
    if entities_path.exists() and not force:
        try:
            ...
            if (
                ...
                and ev.get("api_schema") == stable_version(peeringdb_version)
            ):
    ...
    used_api_version = schema_version  # updated to fallback version if we 404
    try:
